...
class Feedback(commands.Cog):
    ...
    async def fb(self, ctx, *args):
        if ctx.channel.name == self.client.feedback:
            pass

    @commands.Cog.listener()
    async def on_message(self, msg):
        if type(msg.channel) == discord.TextChannel and msg.channel.name == self.client.feedback:
            ...
            receivedChan = discord.utils.get(msg.channel.guild.channels, name=self.client.receivedFeedback)
